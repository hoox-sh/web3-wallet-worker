...
/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 50168f5286615e47c8a51366aa0d10a5)
// Manually extended to add CONFIG_KV and WALLET_CONFIG_KV bindings
// (run `bunx wrangler types --env-interface-type ep-resident` to regenerate).
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "WALLET_MNEMONIC_SECRET" | "WALLET_PK_SECRET">
  > {}
}
